    ...
    <?php endif; ?>
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Chi tiết tài khoản khách hàng: <strong><?= htmlspecialchars($taikhoan['name']) ?></strong></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= BASE_URL_ADMIN . '?act=post-edit-user' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  ...
                  <a href="?act=user" type="submit" class="btn btn-secondary">Quay lại</a>
