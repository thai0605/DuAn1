                ...
                <tbody>
                    <?php foreach ($banners as $key => $banner): ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo BASE_URL_ADMIN . '?act=toggle-banner-status&ID=' . $banner['ID'] . '&Status=' . ($banner['Status'] == 1 ? 0 : 1); ?>"
                                        class="btn btn-warning">
                                        <?= $banner['Status'] == 1 ? 'Ẩn' : 'Hiển thị' ?>
                                    </a>
                                    <a href="<?php echo BASE_URL_ADMIN . '?act=form-edit-banner&ID=' . $banner['ID']; ?>"
                                        class="btn btn-warning">
                                        Sửa
                                    </a>
                                    <!-- Xóa banner -->
                                    <a href="<?php echo BASE_URL_ADMIN . '?act=delete-banner&ID=' . $banner['ID']; ?>"
