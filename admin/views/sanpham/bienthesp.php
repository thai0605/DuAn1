            ...
            <tbody>
              <?php foreach ($listVariants as $variant): ?>
                <tr>
                  ...
                  <td>
                    <a href="?act=form-sua-bien-the&id=<?= $variant['id'] ?>&comic_id=<?= $_GET['id'] ?>"
                      class="btn btn-warning btn-sm">Sửa</a>
                    <a href="?act=xoa-bien-the&id=<?= $variant['id'] ?>&comic_id=<?= $_GET['id'] ?>"
                      onclick="return confirm('Xóa biến thể này?')" class="btn btn-danger btn-sm">Xóa</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
