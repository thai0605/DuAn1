...
class AdminGiaodien
{
   ...
   public function addBanner($Title, $Description, $Image, $Status, $Position)
   {
      $sql = "INSERT INTO banners (Title,  Description,Image, Status, Position)
                VALUES (:Title,  :Description,:Image, :Status, :Position)";
   ...
   // 
   public function insertBanner($Title, $Description, $Image, $Status, $Position)
   {
      try {
         // Kiểm tra giá trị truyền vào
         if (empty($Title) || empty($Description) || empty($Image) || empty($Status)) {
            throw new Exception("Các trường Title, Description, Image và Status không được để trống.");
         }
   ...
   public function updateBanner($ID, $Title, $Description, $Image, $Status, $Position, $Create_at, $Update_at)
   {
      try {
         $sql = 'UPDATE banners
            SET
   ...
   public function updateBanners($ID, $Title, $Description, $Image, $Status, $Position)
   {
      try {
